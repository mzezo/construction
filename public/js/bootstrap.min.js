...
!(function (t, e) {
  ...
  const Z = 'left';
  const J = 'right';
  const tt = { ArrowLeft: J, ArrowRight: Z };
  class et extends q {
    constructor(t, e) {
      super(t),
        (this._items = null),
  ...
  const it = { toggle: 'boolean', parent: '(string|element)' };
  class nt extends q {
    constructor(t, e) {
      super(t),
  ...
  class pt extends q {
    ...
    static dataApiKeydownHandler(t) {
      ...
      return t.key === 'Escape'
        ...
        : void ((e && t.key !== 'Space') || pt.clearMenus());
    }
  }
  B.on(
    document,
  ...
  class bt {
    ...
    _getConfig(t) {
      return (
        ((t = { ...mt, ...(typeof t === 'object' ? t : {}) }).rootElement = h(
          t.rootElement
        )),
        d('backdrop', t, _t),
        t
  ...
  const At = { backdrop: 'boolean', keyboard: 'boolean', scroll: 'boolean' };
  class Tt extends q {
    constructor(t, e) {
      super(t),
        (this._config = this._getConfig(e)),
  ...
  const Bt = { ...jt.DefaultType, content: '(string|element|function)' };
  const $t = {
  ...
  const zt = { offset: 'number', method: 'string', target: '(string|element)' };
  class Ft extends q {
    constructor(t, e) {
      super(t),
        (this._scrollElement =
  ...
  class Ut extends q {
    ...
    _transitionComplete(t, e, s) {
      ...
      let n = t.parentNode;
      if (
        (n && n.nodeName === 'LI' && (n = n.parentNode),
  ...
  const Vt = { animation: !0, autohide: !0, delay: 5e3 };
  class Qt extends q {
    constructor(t, e) {
      super(t),
        (this._config = this._getConfig(e)),
