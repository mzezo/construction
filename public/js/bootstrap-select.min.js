  ...
  !(function (T) {
    ...
    function P(e, t, i) {
      ...
      for (let s = Object.keys(t), n = 0, o = e.length; n < o; n++)
        for (
          let l = e[n].querySelectorAll('*'), r = 0, a = l.length;
          r < a;
          r++
        ) {
          const c = l[r];
    ...
    if ((t.classList.add('c1', 'c2'), !t.classList.contains('c2'))) {
      const i = DOMTokenList.prototype.add;
      const s = DOMTokenList.prototype.remove;
    ...
    if ((t.classList.toggle('c3', !1), t.classList.contains('c3'))) {
      const o = DOMTokenList.prototype.toggle;
    ...
    const u = { useDefault: !1, _set: T.valHooks.select.set };
    ...
    const g = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g;
    const b = RegExp(
      '[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\u1ab0-\\u1aff\\u1dc0-\\u1dff]',
      'g'
    );
    ...
    const E =
      ...
      (S = RegExp(y, 'g')),
      function (e) {
        return (e = e == null ? '' : `${e}`), $.test(e) ? e.replace(S, C) : e;
      });
    function C(e) {
      return x[e];
    }
    ...
    const M = 38;
    const R = 40;
    const U = window.Dropdown || bootstrap.Dropdown;
    function V() {
      let t;
      try {
    ...
    const q = { MENU: `.${G.MENU}`, DATA_TOGGLE: 'data-toggle="dropdown"' };
    const K = {
    ...
    const Q = new RegExp(`${M}|${R}`);
    const Y = new RegExp(`^${B}$|${N}`);
    const Z = {
      li(e, t, i) {
        const s = K.li.cloneNode(!1);
        return (
          e &&
      ...
      text(e, t) {
        let i;
        let s;
        const n = K.text.cloneNode(!1);
        if (e.content) n.innerHTML = e.content;
        else {
          if (((n.textContent = e.text), e.icon)) {
            const o = K.whitespace.cloneNode(!1);
            ((s = (!0 === t ? K.i : K.span).cloneNode(
              !1
            )).className = `${this.options.iconBase} ${e.icon}`),
      ...
      label(e) {
        let t;
        let i;
        const s = K.text.cloneNode(!1);
        if (((s.innerHTML = e.display), e.icon)) {
          const n = K.whitespace.cloneNode(!1);
          ((i = K.span.cloneNode(
            !1
          )).className = `${this.options.iconBase} ${e.icon}`),
    ...
    const J = {
      fromOption(e, t) {
        ...
        switch (t) {
          case 'divider':
            i = e.getAttribute('data-divider') === 'true';
            break;
          case 'text':
            i = e.textContent;
            break;
    ...
    (te.VERSION = '1.14.0-beta2'),
      ...
      (te.prototype = {
        ...
        createDropdown() {
          ...
          const t = this.multiple ? ' aria-multiselectable="true"' : '';
          let i = '';
          const s = this.autofocus ? ' autofocus' : '';
          j.major < 4 &&
          ...
          return (
            this.options.header &&
              (o = `<div class="${G.POPOVERHEADER}"><button type="button" class="close" aria-hidden="true">&times;</button>${this.options.header}</div>`),
            this.options.liveSearch &&
              (l = `<div class="bs-searchbox"><input type="search" class="form-control" autocomplete="off"${
            ...
            this.multiple &&
              ...
              (r = `<div class="bs-actionsbox"><div class="btn-group btn-group-sm"><button type="button" class="actions-btn bs-select-all btn ${G.BUTTONCLASS}">${this.options.selectAllText}</button><button type="button" class="actions-btn bs-deselect-all btn ${G.BUTTONCLASS}">${this.options.deselectAllText}</button></div></div>`),
            this.multiple &&
              this.options.doneButton &&
              (a = `<div class="bs-donebutton"><div class="btn-group"><button type="button" class="btn btn-sm ${G.BUTTONCLASS}">${this.options.doneButtonText}</button></div></div>`),
            this.options.allowClear &&
              (c = `<span class="close bs-select-clear-selected" title="${this.options.deselectAllText}"><span>&times;</span>`),
            (n = `<div class="dropdown bootstrap-select${e}${i}"><button type="button" tabindex="-1" class="${
              this.options.styleBase
            } dropdown-toggle" ${
              this.options.display === 'static' ? 'data-display="static"' : ''
            }${q.DATA_TOGGLE}${s} role="combobox" aria-owns="${
              this.selectId
            }" aria-haspopup="listbox" aria-expanded="false"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">&nbsp;</div></div> </div>${c}</span>${
              j.major >= '4'
                ? ''
                : `<span class="bs-caret">${this.options.template.caret}</span>`
            }</button><div class="${G.MENU} ${
              j.major >= '4' ? '' : G.SHOW
            }">${o}${l}${r}<div class="inner ${G.SHOW}" role="listbox" id="${
              this.selectId
            }" tabindex="-1" ${t}><ul class="${G.MENU} inner ${
              j.major >= '4' ? G.SHOW : ''
            }" role="presentation"></ul></div>${a}</div></div>`),
            T(n)
          );
        },
        setPositionData() {
        ...
        createView(z, e, t) {
          ...
          if (
            ...
            if (t) i = this.$menuInner[0].scrollTop;
              ...
              const s = N.$element[0];
              const n = (s.options[s.selectedIndex] || {}).liIndex;
              if (typeof n === 'number' && !1 !== N.options.size) {
                const o = N.selectpicker.main.data[n];
                const l = o && o.position;
                l &&
                  (i =
          ...
          function W(e, t) {
            ...
            let a;
            let c;
            const d = N.selectpicker.current.data.length;
            const h = [];
            let p = !0;
            const u = N.isVirtual();
            ...
            if (
              ...
              if (
                ...
                let v;
                let g;
                const b = N.$menuInner[0];
                const w = document.createDocumentFragment();
                const I = b.firstChild.cloneNode(!1);
                const x = N.selectpicker.view.visibleElements;
                const k = [];
                b.replaceChild(I, b.firstChild);
                f = 0;
                for (let y = x.length; f < y; f++) {
                  var $;
                  var S;
                  const E = x[f];
                  N.options.sanitize &&
                ...
                if (
                  ...
                  !0 === u
                    ? ((v =
                        N.selectpicker.view.position0 === 0
                          ? 0
                          : N.selectpicker.current.data[
                  ...
                  const C = b.firstChild.offsetWidth;
                  if (
                    t &&
                    ...
                    const O = b.firstChild.offsetWidth;
        ...
        setPlaceholder() {
          ...
          if (
            ...
            let s = !1;
            const n = !this.selectpicker.view.titleOption.parentNode;
            const o = i.selectedIndex;
            const l = i.options[o];
            const r = i.querySelector('select > *:not(:disabled)');
            const a = r ? r.index : 0;
            const c =
              window.performance &&
            ...
            n &&
              ...
              (!n && this.selectpicker.view.titleOption.index === 0) ||
                i.insertBefore(
                  this.selectpicker.view.titleOption,
                  i.firstChild
                ),
        ...
        buildData(p, e) {
          const u = !1 === p ? J.fromOption : J.fromDataSource;
          let f = ':not([hidden]):not([data-hidden="true"])';
          const m = [];
          let l = 0;
          let v = 0;
          const g = this.setPlaceholder() && !p ? 1 : 0;
          e === 'load'
            ? (l = this.selectpicker.main.data.length)
            : e === 'search' && (l = this.selectpicker.search.data.length),
        ...
        buildList(e, t) {
          ...
          for (let r = e || 0, a = i.length, c = r; c < a; c++) {
            l(s, i[c]);
          }
          e
            ? t
        ...
        render(e) {
          ...
          let n = this.setPlaceholder() && s.selectedIndex === 0;
          const o = A.call(this);
          const l = o.length;
          const r = z.call(this, o);
          const a = this.$button[0];
          const c = a.querySelector('.filter-option-inner-inner');
          const d = document.createTextNode(this.options.multipleSeparator);
          let h = K.fragment.cloneNode(!1);
          let p = !1;
          if (
            ...
            if (!n) {
              for (let u = 0; u < l && u < 50; u++) {
                const f = o[u];
                const m = {};
                f &&
                  (this.multiple && u > 0 && h.appendChild(d.cloneNode(!1)),
                  f.title
                    ? (m.text = f.title)
          ...
          if (
            ...
            const w = a.querySelector('.filter-expand');
        ...
        liHeight(e) {
          if (
            ...
            let t;
            const i = K.div.cloneNode(!1);
            const s = K.div.cloneNode(!1);
            const n = K.div.cloneNode(!1);
            const o = document.createElement('ul');
            const l = K.li.cloneNode(!1);
            const r = K.li.cloneNode(!1);
            const a = K.a.cloneNode(!1);
            const c = K.span.cloneNode(!1);
            const d =
              this.options.header &&
              this.$menu.find(`.${G.POPOVERHEADER}`).length > 0
                ? this.$menu.find(`.${G.POPOVERHEADER}`)[0].cloneNode(!0)
                : null;
            const h = this.options.liveSearch ? K.div.cloneNode(!1) : null;
            const p =
              this.options.actionsBox &&
              this.multiple &&
            ...
            const u =
              ...
              this.$menu.find('.bs-donebutton').length > 0
                ...
                : null;
            const f = this.$element[0].options[0];
            if (
              ...
              (i.style.width = 0),
              this.options.width === 'auto' && (s.style.minWidth = 0),
              (s.className = `${G.MENU} ${G.SHOW}`),
              (n.className = `inner ${G.SHOW}`),
              (o.className = `${G.MENU} inner ${j.major >= '4' ? G.SHOW : ''}`),
              (l.className = G.DIVIDER),
              (r.className = 'dropdown-header'),
              c.appendChild(document.createTextNode('\u200b')),
              this.selectpicker.current.data.length)
            )
              for (let m = 0; m < this.selectpicker.current.data.length; m++) {
                const v = this.selectpicker.current.data[m];
                if (v.type === 'option') {
                  t = v.element;
                  break;
                }
            ...
            const I = r ? r.offsetHeight : 0;
            const x = d ? d.offsetHeight : 0;
            const k = h ? h.offsetHeight : 0;
            const y = p ? p.offsetHeight : 0;
            const $ = u ? u.offsetHeight : 0;
            const S = T(l).outerHeight(!0);
        ...
        getSelectPosition() {
          ...
          const s = T(this.options.container);
        ...
        setMenuSize(e) {
          ...
          let r;
          let a;
          const c = this.sizeInfo.selectWidth;
          const d = this.sizeInfo.liHeight;
          const h = this.sizeInfo.headerHeight;
          const p = this.sizeInfo.searchHeight;
          const u = this.sizeInfo.actionsHeight;
          const f = this.sizeInfo.doneButtonHeight;
          const m = this.sizeInfo.dividerHeight;
          const v = this.sizeInfo.menuPadding;
          let g = 0;
          if (
            ...
            for (let b = 0; b < this.options.size; b++)
        ...
        selectPosition() {
          ...
          let o;
          var l = this;
          var r = T(this.options.container);
          this.$button.on('click.bs.dropdown.data-api', function () {
            ...
            T(window)
              ...
              .on(
                `resize${F}.${this.selectId} scroll${F}.${this.selectId}`,
                function () {
        ...
        createOption(e, t) {
          const i = e.option ? e.option : e;
          if (i && i.nodeType !== 1) {
            const s = (t ? K.selectedOption : K.option).cloneNode(!0);
        ...
        setSelected(e, t) {
          ...
          const r = this.activeIndex === n || (t && !this.multiple && !l);
          o &&
            (void 0 !== t &&
          ...
          t.data('spaceSelect', !1),
                  ...
                  (t !== i && t.parentElement !== i) ||
                    ...
                    (function () {
                      if (O.multiple) O.deselectAll();
                        ...
                        const s = e.options[i];
                        const n = !!s && O.selectpicker.main.data[s.liIndex];
                        n && O.setSelected(n, !1),
                          (e.selectedIndex = 0),
                          (D = [i, !1, t]),
            ...
            this.$element.on(`shown${F}`, function () {
              O.$menuInner[0].scrollTop !== O.selectpicker.view.scrollTop &&
                (O.$menuInner[0].scrollTop = O.selectpicker.view.scrollTop),
                j.major > 3 ? requestAnimationFrame(i) : e();
            }),
            this.$menuInner.on('mouseenter', 'li a', function (e) {
              const t = this.parentElement;
              const i = O.isVirtual() ? O.selectpicker.view.position0 : 0;
              const s = Array.prototype.indexOf.call(
                t.parentElement.children,
                t
              );
              const n = O.selectpicker.current.data[s + i];
              O.focusItem(t, n, !0);
            }),
            this.$menuInner.on('click', 'li a', function (e, t) {
              const i = T(this);
              const s = O.$element[0];
              const n = O.isVirtual() ? O.selectpicker.view.position0 : 0;
              const o = O.selectpicker.current.data[i.parent().index() + n];
              const l = o.index;
              const r = z.call(O);
              const a = s.selectedIndex;
              const c = s.options[a];
              const d = !!c && O.selectpicker.main.data[c.liIndex];
              let h = !0;
              if (
                (O.multiple &&
                  O.options.maxOptions !== 1 &&
                  e.stopPropagation(),
                e.preventDefault(),
                ...
                const u = T(p);
                const f = p.selected;
                const m = u.parent('optgroup');
                const v = m.find('option');
                const g = O.options.maxOptions;
                const b = m.data('maxOptions') || !1;
                if (
                  (l === O.activeIndex && (t = !0),
                  t ||
                  ...
                  if (
                    ...
                    const w = g < A.call(O).length;
                    const I = b < m.find('option:selected').length;
                    if ((g && w) || (b && I))
                      if (g && g == 1)
                        (s.selectedIndex = -1),
                          (p.selected = !0),
                        ...
                        const y =
                          typeof O.options.maxOptionsText === 'string'
                            ? [
                                O.options.maxOptionsText,
                                O.options.maxOptionsText,
                              ]
                            : O.options.maxOptionsText;
                        const $ = typeof y === 'function' ? y(g, b) : y;
                        let S = $[0].replace('{n}', g);
                        let E = $[1].replace('{n}', b);
                        const C = T('<div class="notify"></div>');
                        $[2] &&
                          ((S = S.replace('{var}', $[2][g > 1 ? 0 : 1])),
                          (E = E.replace('{var}', $[2][b > 1 ? 0 : 1]))),
                          (p.selected = !1),
                          O.$menu.append(C),
                          g &&
                            w &&
                ...
                O.options.source.data &&
                  ...
                  !O.multiple || (O.multiple && O.options.maxOptions === 1)
            ...
            this.$button
              .on(`focus${F}`, function (e) {
                const t = O.$element[0].getAttribute('tabindex');
                void 0 !== t &&
                  e.originalEvent &&
        ...
        val(t) {
          ...
          const i = A.call(this);
          const s = z.call(this, i);
          (D = [null, null, s]), Array.isArray(t) || (t = [t]), t.map(String);
          for (let n = 0; n < i.length; n++) {
            const o = i[n];
            o && t.indexOf(String(o.value)) === -1 && this.setSelected(o, !1);
          }
          if (
            (this.selectpicker.main.data.filter(function (e) {
              return (
                t.indexOf(String(e.value)) !== -1 &&
            ...
            if (this.multiple) this.setOptionStatus(!0);
              ...
              const l = (e.options[e.selectedIndex] || {}).liIndex;
              typeof l === 'number' &&
        ...
        changeAll(e) {
          if (this.multiple) {
            ...
            t.classList.add('bs-select-hidden');
            for (
              let o = 0, l = this.selectpicker.current.data, r = l.length;
              o < r;
              o++
            ) {
              const a = l[o];
        ...
        keydown(e) {
          ...
          const a = (r ? l.closest('.dropdown') : l.closest(q.MENU)).data(
            'this'
          );
          const c = a.findLis();
          let d = !1;
          const h = e.which === B && !r && !a.options.selectOnTab;
          const p = Q.test(e.which) || h;
          const u = a.$menuInner[0].scrollTop;
          const f = !0 === a.isVirtual() ? a.selectpicker.view.position0 : 0;
          if (!(e.which >= 112 && e.which <= 123))
            if (
              ...
              if (
                ...
                for (let w = 0; w < a.selectpicker.current.data.length; w++) {
                  const I = a.selectpicker.current.data[w];
                  k(I, g, 'startsWith', !0) &&
